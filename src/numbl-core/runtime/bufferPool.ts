 ...
 *
 * The pool's release path was removed along with the refcount system; the
 * acquire path is preserved as a thin allocator. Buckets stay empty, so
 * every acquire is currently a fresh allocation. The pool will be
 * redesigned alongside the new anti-aliasing system.
 */
...
/** Telemetry snapshot of a BufferPool. */
