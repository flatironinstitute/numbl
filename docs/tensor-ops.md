...
- Element-wise binary/unary ops lived in [native/elemwise.cpp](../native/elemwise.cpp)
  ...
  files (e.g. [src/numbl-core/executors/jsJit/js/jitHelpersTensor.ts](../src/numbl-core/executors/jsJit/js/jitHelpersTensor.ts))
...
**3. JIT helpers** ([src/numbl-core/executors/jsJit/js/jitHelpersTensor.ts](../src/numbl-core/executors/jsJit/js/jitHelpersTensor.ts)):
